...
class TestEnumTypeValidator(BaseValidatorTest):
    @parameterized.expand([
        ('with_str_enum_valid_value', 'success', RuleType(
            schema_type=SchemaTypes.ENUM, lookup='message'), string_enum, 0),
        ('with_str_enum_invalid_value', 'not_found',
            RuleType(schema_type=SchemaTypes.ENUM, lookup='message'), string_enum, 1),
        ('with_str_enum_empty_str_value', '',
            RuleType(schema_type=SchemaTypes.ENUM, lookup='message'), string_enum, 1),
        ('with_str_rule_type', 'success', RuleType(schema_type=SchemaTypes.STR), string_enum, 0),
        ('with_enum_not_found', 'success', RuleType(
            schema_type=SchemaTypes.ENUM, lookup='errors'), string_enum, 1),
        ('with_non_str_data_type', [0, 1, 2], RuleType(
            schema_type=SchemaTypes.ENUM, lookup='message'), string_enum, 1),
        ...
        ('with_int_enum_valid_value', 1,  RuleType(
            schema_type=SchemaTypes.ENUM, lookup='message'), int_enum, 0),
        ('with_int_enum_invalid_value', 100,  RuleType(
            schema_type=SchemaTypes.ENUM, lookup='message'), int_enum, 1),
        ('with_int_enum_invalid_str_value', '1',  RuleType(
            schema_type=SchemaTypes.ENUM, lookup='message'), int_enum, 1),
        ('with_float_enum_valid_value', 3.142,  RuleType(
            schema_type=SchemaTypes.ENUM, lookup='digits'), float_enum, 0),
        ('with_float_enum_invalid_value', 4.2,  RuleType(
            schema_type=SchemaTypes.ENUM, lookup='digits'), float_enum, 1),
